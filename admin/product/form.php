        ...
        <form action="process.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mt-3">
                ...
                <input type="text" class="form-control" name="product_name" id="productName"
                    placeholder="Entrez le nom du produit" value="<?= $productName; ?>">
            </div>

            <div class="form-group mt-3">
                <label for="productDescription">Description :</label>
                <input type="text" class="form-control" name="product_description" id="productName"
                    placeholder="Entrez la description du produit" value="<?= $productDescription; ?>">
            </div>
            ...
            <div class="form-group mt-3">
                ...
                <input type="text" class="form-control" name="product_cartoonist" id="productCartoonist"
                    placeholder="Entrez le nom du dessinateur du produit" value="<?= $productCartoonist; ?>">
            </div>
